...
class FeedController extends Controller
{
    ...
    public function maintenanceIcal(Request $request)
    {
    ...
    public function statusRssFeed(Request $request)
    {
        Cache::forget('feed_groups_for_incidents_json');
        $components = Cache::remember('feed_groups_for_incidents_json', 1, function () {
